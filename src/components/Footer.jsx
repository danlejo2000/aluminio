    ...
    <footer className="bg-otto-dark py-10">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center text-gray-400">
        <div className="mb-6 flex justify-center space-x-8">
            <a href="https://www.facebook.com/groups/495654765639023/?locale=es_LA" target="_blank" rel="noopener noreferrer" className="text-white hover:text-otto-orange transition duration-300 transform hover:scale-110" aria-label="Síguenos en Facebook">
            ...
            <a href="https://www.instagram.com/aluminiosotto" target="_blank" rel="noopener noreferrer" className="text-white hover:text-otto-orange transition duration-300 transform hover:scale-110" aria-label="Síguenos en Instagram">
        ...
        <p className="text-base">&copy; 2026 Aluminios OTTO SAS. Todos los derechos reservados. Bogotá, Colombia</p>
        <p className="mt-2 text-sm text-gray-500">Transformando ideas con la resistencia y belleza del aluminio.</p>
        <p className="mt-3 text-xs text-gray-600">
          <a href="#inicio" className="hover:text-otto-orange transition">Inicio</a> | 
          <a href="#productos" className="hover:text-otto-orange transition ml-2">Productos</a> | 
          <a href="#servicios" className="hover:text-otto-orange transition ml-2">Servicios</a> | 
          <a href="#contacto" className="hover:text-otto-orange transition ml-2">Contacto</a> |
          <a href="#sitemap" className="hover:text-otto-orange transition ml-2">Mapa del Sitio</a>
        </p>
        <p className="mt-2 text-xs text-gray-600">Perfiles de Aluminio | Ventanas | Puertas | Accesorios | Sistemas Completos | Despachos a toda Colombia</p>
      </div>
    </footer>
  );
};
