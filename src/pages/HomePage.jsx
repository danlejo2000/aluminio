...
<video 
  ...
  aria-label="Video de fondo mostrando sistemas de aluminio OTTO"
>
  ...
  Tu navegador no soporta la reproducción de videos HTML5.
    ...
    <div className="container mx-auto px-6 z-10 relative text-center">
        <h1 className="text-5xl md:text-7xl font-extrabold font-heading text-white leading-tight mb-6 drop-shadow-2xl">
            ...
            Perfiles, Ventanas, Puertas y Accesorios de Aluminio
        </h1>
        <p className="text-xl md:text-2xl text-gray-300 mb-10 font-light max-w-3xl mx-auto drop-shadow-md">
            Distribuidor líder en aluminio arquitectónico. Sede en Bogotá con envíos a toda Colombia. Sistemas completos, accesorios y asesoría técnica. +20 años transformando espacios.
        </p>
          ...
          <div className="container mx-auto px-6 lg:px-12 flex flex-col md:flex-row items-center gap-16">
              <div className="md:w-1/2">
                    <h2 className="text-4xl font-bold font-heading text-otto-dark mb-6">
                        Más de 20 años de <span className="text-otto-orange">Excelencia</span> en Aluminio Arquitectónico.
                    </h2>
                    <p className="text-lg text-gray-600 mb-6">
                        En <strong>Aluminios OTTO</strong>, somos distribuidores líderes en <strong>perfilería de aluminio</strong> de la más alta calidad en Colombia. Ofrecemos <strong>sistemas completos</strong>: ventanas corredizas, puertas oscilo-batientes, sistemas plegables, <strong>accesorios</strong> (bisagras, rodamientos, cierres, empaques) y <strong>perfiles arquitectónicos</strong> para proyectos residenciales, comerciales e industriales. Con sede en Bogotá y <strong>despachos a todo el país</strong>, nuestros sistemas europeos Astral, Kimbaya, Zinu, Tairona y Colosal garantizan durabilidad, hermeticidad y diseño moderno.
                    </p>
              ...
              <div className="md:w-1/2 relative">
                  ...
                  <img 
                    ...
                    alt="Equipo profesional de Aluminios OTTO trabajando en instalación de sistemas de aluminio" 
          ...
          <div className="container mx-auto px-6 relative z-10">
                <div className="text-center mb-12">
                  <h2 className="text-4xl md:text-5xl font-bold font-heading text-white">
                    Catálogo de <span className="text-otto-orange">Sistemas de Aluminio</span>
                  </h2>
                  <p className="mt-4 text-gray-400 max-w-2xl mx-auto text-lg">
                    Ventanas y puertas de aluminio con certificación europea. Sistemas corredizos, oscilo-batientes y plegables para construcción moderna en Colombia.
                  </p>
                                    ...
                                    >
                                        <div className="absolute inset-0">
                                            <img 
                                                ...
                                                alt={`Sistemas de ${cat} en aluminio - Aluminios OTTO`} 
      ...
      <section id="servicios" className="py-24 bg-gray-100"> 
          <div className="container mx-auto px-6 text-center">
              <h2 className="text-4xl font-bold font-heading text-otto-dark mb-12">Servicios Profesionales de <span className="text-otto-orange">Aluminio en Colombia</span></h2>
      ...
      <section className="bg-otto-orange py-16 text-white text-center">
          <div className="container mx-auto px-6">
              <h2 className="text-3xl md:text-4xl font-extrabold mb-4 font-heading">¿Listo para tu Proyecto de Aluminio?</h2>
              <p className="text-xl mb-8 opacity-90 max-w-3xl mx-auto">
                  Cotiza perfiles, ventanas, puertas, accesorios y sistemas de aluminio arquitectónico. Despachos a toda Colombia desde Bogotá. Asesoría técnica profesional sin costo.
              </p>
          ...
          <div className="container mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
              <div className="text-white">
                  <h2 className="text-4xl font-bold font-heading mb-6">
                    Contáctanos - <span className="text-otto-orange">Sede Bogotá</span>
                  </h2>
                  <p className="text-gray-400 mb-10 text-lg">
                      Cotiza perfiles, ventanas, puertas, accesorios y sistemas de aluminio. Atención personalizada, asesoría técnica y despachos a toda Colombia. Sede principal en La Soledad, Bogotá.
                  </p>
